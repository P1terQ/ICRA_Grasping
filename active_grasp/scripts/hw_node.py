...
class HwNode:
    ...
    def load_config(self):
        ...
        q0 = scene_config["q0"] #! q0应该是蛇皮走位的姿态
    ...
    def publish_table_co(self, event):
        ...
        msg.pose = to_pose_msg(self.T_base_roi * Transform.t_[0.15, 0.15, 0.005])   #? 这个transform是不是手动定义得偏置
        # self.moveit.scene.add_box("table", msg, size=(0.8, 0.8, 0.01))  #! 在场景中添加一个box，可以避免碰撞
